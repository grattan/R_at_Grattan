...
```{r hadley, echo=FALSE, out.width='100%'} 
knitr::include_graphics("atlas/hadley_typing_r_code.gif")
```
...
```{r reinhart-rogoff, echo=FALSE, out.width='100%'} 
knitr::include_graphics("atlas/reinhart_rogoff.jpg")
```
