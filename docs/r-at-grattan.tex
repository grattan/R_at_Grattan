...
This guide is designed for \emph{everyone} using R at Grattan Institute.
...
As a guide to using R, this document is helpful but incomplete. We can't possibly cover all the skills you might need to know. If you make it to the end of this guide and want to learn more, start by reading \href{https://r4ds.had.co.nz}{R for Data Science} by Hadley Wickham and Garrett Grolemund. It's free.
...
\includegraphics{r-at-grattan_files/figure-latex/add_theme_grattan-1.pdf}
...
\includegraphics{r-at-grattan_files/figure-latex/add_grattan_y_continuous-1.pdf}
...
\includegraphics{r-at-grattan_files/figure-latex/add_fill-1.pdf}
