...
Looks marvellous! Now you can export as a full-slide Grattan chart using \texttt{grattan\_save}:
...
Looks pre-eminent! Now you can add titles and a caption, and save using \texttt{grattan\_save}:
...
Looks very good. The last label on the x-axis goes off the page a bit so you can expand the plot to the right in the \texttt{grattan\_x\_continuous} element:
