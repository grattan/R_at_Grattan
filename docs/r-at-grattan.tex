...
\hypersetup{
  ...
  pdfauthor={Matt Cowgill, Will Mackey, and James Ha},
  hidelinks,
...
\includegraphics{atlas/r_cran_windows_1.png} \includegraphics{atlas/r_cran_windows_2.png}
...
\includegraphics{atlas/reinhart_rogoff.jpg}
...
\includegraphics{atlas/rstudio_navigation.png}
...
\begin{center}\includegraphics{atlas/ggplot_cheat_sheet} \end{center}
