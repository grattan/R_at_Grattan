...
Looks outstanding! Now you can export as a full-slide Grattan chart using \texttt{grattan\_save}:
...
Looks tremendous! Now you can add titles and a caption, and save using \texttt{grattan\_save}:
...
Looks tremendous! To make the point a little clearer, we can overlay a point for average income each percentile. Create a dataset that has the average income for each area and professional work category:
