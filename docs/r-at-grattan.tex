...
Looks sterling! Now you can export as a full-slide Grattan chart using \texttt{grattan\_save}:
...
Looks marvellous! Now you can add titles and a caption, and save using \texttt{grattan\_save}:
