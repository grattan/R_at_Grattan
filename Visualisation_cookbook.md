...
Looks top-notch: you have one observation (row) for each state you want to plot, and a value for their number of workers.
...
Looks champion! Now you can add titles and a caption, and save using `grattan_save`:
