...
To add labels, first decide where they should go. Try positioning the `r col_text("Professional", grattan_red)` above its averages, and `r col_text("Non-professional", grattan_orange)` at the bottom. 
